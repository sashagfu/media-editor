<?php  //[STAMP] 97a4cfd409551c64cea50f8c4d937408
...
trait AcceptanceTesterActions
{
     ...
     *
     * @return void
     * @see \Helper\Mailtrap::cleanInbox()
     */
    public function cleanInbox() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('cleanInbox', func_get_args()));
    }
     ...
     *
     * @return mixed
     * @see \Helper\Mailtrap::receiveAnEmail()
     */
     ...
     *
     * @return array
     * @see \Helper\Mailtrap::fetchLastMessage()
     */
    public function fetchLastMessage() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('fetchLastMessage', func_get_args()));
    }
     ...
     *
     * @return array
     * @see \Helper\Mailtrap::fetchAttachmentsOfLastMessage()
     */
    public function fetchAttachmentsOfLastMessage() {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('fetchAttachmentsOfLastMessage', func_get_args()));
    }
     ...
     *
     * @return mixed
     * @see \Helper\Mailtrap::receiveAnEmailFromEmail()
     */
     ...
     *
     * @return mixed
     * @see \Helper\Mailtrap::receiveAnEmailFromName()
     */
     ...
     *
     * @return mixed
     * @see \Helper\Mailtrap::receiveAnEmailToEmail()
     */
     ...
     *
     * @return mixed
     * @see \Helper\Mailtrap::receiveAnEmailToName()
     */
     ...
     *
     * @return mixed
     * @see \Helper\Mailtrap::receiveAnEmailWithSubject()
     */
     ...
     *
     * @return mixed
     * @see \Helper\Mailtrap::receiveAnEmailWithTextBody()
     */
     ...
     *
     * @return mixed
     * @see \Helper\Mailtrap::receiveAnEmailWithHtmlBody()
     */
     ...
     * @return mixed
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Helper\Mailtrap::seeInEmailTextBody()
     */
     ...
     * @return mixed
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Helper\Mailtrap::seeInEmailHtmlBody()
     */
     ...
     * @param $count
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Helper\Mailtrap::seeAttachments()
     */
    public function canSeeAttachments($count) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeAttachments', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
    ...
    public function seeAttachments($count) {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeAttachments', func_get_args()));
    }
     ...
     * @param $bool
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Helper\Mailtrap::seeAnAttachment()
     */
    public function canSeeAnAttachment($bool) {
        return $this->getScenario()->runStep(new \Codeception\Step\ConditionalAssertion('seeAnAttachment', func_get_args()));
    }
    /**
     * [!] Method is generated. Documentation taken from corresponding module.
     *
    ...
    public function seeAnAttachment($bool) {
        return $this->getScenario()->runStep(new \Codeception\Step\Assertion('seeAnAttachment', func_get_args()));
    }
}
