        ...
        <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
            <center>
                <table cellspacing="0" cellpadding="0" width="600" class="w320">
                    <tr>
                        <td class="header-lg">
                            {{ trans('email.welcome_to') }} <span style="text-transform: capitalize;">{{config('app.name')}}</span>
                        </td>
                    </tr>
                    <tr>
                        <td class="free-text">
                            <h3>{{ trans('email.welcome', ['username' => $user->username]) }}</h3>
                            {{ trans('email.we_are_happy', ['sitename' => config('site.name')]) }}
                        </td>
                    </tr>
                    <tr>
                        <td class="button">
                            <div><!--[if mso]>
                                ...
                                <![endif]--><a class="button-mobile" href="{!! $verification_link !!}"
                                               style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">{{ trans('email.verify_email') }}</a></div>
                        </td>
                    </tr>
                </table>
            </center>
