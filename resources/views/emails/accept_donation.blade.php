                                ...
                                <table cellpadding="0" cellspacing="0" width="600" class="w320">
                                    <tr>
                                        <td class="pull-left mobile-header-padding-left"
                                            ...
                                            <a href="{!! config('app.url') !!}"><h2>{{ config('app.name') }}</h2></a>
                                        </td>
        ...
        <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
            <center>
                <table cellspacing="0" cellpadding="0" width="600" class="w320">
                    <tr>
                        <td class="header-lg">
                            {{ trans('email.welcome_to') }} <span
                                    style="text-transform: capitalize;">{{config('app.name')}}</span>
                        </td>
                    </tr>
                    <tr>
                        <td class="free-text"><p>{{trans('donate.donation_notify', ['donor_name' => $payer->display_name, 'amount' => $transaction->amount])}}</p></td>
                    </tr>
                    <tr>
                        <td class="button">
                            <div><!--[if mso]>
                                ...
                                <![endif]-->
                                <a class="button-mobile" href="{!! $accept_link !!}"
                                   style="background-color:#53b847;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">{{ trans('donate.accept_donation') }}</a>
                                <a class="button-mobile" href="{!! $decline_link !!}"
                                   style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">{{ trans('donate.decline_donation') }}</a>
                            </div>
                        </td>
                    </tr>
                </table>
