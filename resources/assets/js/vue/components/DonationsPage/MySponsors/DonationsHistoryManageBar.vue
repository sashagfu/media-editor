<template>
  <div class="DonationsHistoryManageBar dh-manage-bar">
    <div class="dh-manage-bar__left">
      <div class="dh-manage-bar__title">
        {{ trans('donate.donations_history') }}
      </div>
    </div>
    <div class="dh-manage-bar__right">
      <el-input
        :value="searchText"
        :placeholder="trans('common.quick_search')"
        size="mini"
        class="input-with-select dh-manage-bar__search-inp"
        @input="debounceInput"
      >
        <el-button
          v-if="!searchText"
          slot="append"
          class="dh-manage-bar__search-btn"
        >
          <font-awesome-icon
            :icon="['fas', 'search']"
            class="fa-icon"
