<template>
  <div class="FollowersManageBar fw-manage-bar">
    <div class="fw-manage-bar__left"/>
    <div class="fw-manage-bar__right">
      <el-input
        :value="searchText"
        :placeholder="trans('common.quick_search')"
        size="mini"
        class="input-with-select fw-manage-bar__search-inp"
        @input="debounceInput"
      >
        <el-button
          v-if="!searchText"
          slot="append"
          class="fw-manage-bar__search-btn"
        >
          <font-awesome-icon
            :icon="['fas', 'search']"
            class="fa-icon"
