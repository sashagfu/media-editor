<template>
  <div class="UploadItem">
    <div class="upload-item">
      <div class="upload-item__title-box">
        <div
          class="upload-item__title"
        >
          {{ decodeURI(file.name) }}
        </div>
        <div class="upload-item__sub-title">
    ...
    >
      <div
        :class="{
          'upload-item__progress-meter--warning': processing && !done,
          'upload-item__progress-meter--success': done
        }"
        :style="{width: `${progress}%`}"
        class="upload-item__progress-meter"
      />
    </div>
  </div>
</template>
